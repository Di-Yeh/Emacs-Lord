  ...
  (unless (or (bound-and-true-p my-lsp-setup-done)
    ...
    (cond
     ...
     ((and (derived-mode-p 'prog-mode)
           (member major-mode '(clojure-mode clojurec-mode clojurescript-mode c-mode c++-mode  java-mode csharp-mode python-mode lua-mode))) ; 如果要使用clojure就加入 clojure-mode clojurec-mode clojurescript-mode 即可

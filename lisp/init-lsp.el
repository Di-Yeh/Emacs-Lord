  ...
  (unless (or (bound-and-true-p my-lsp-setup-done)
    ...
    (cond
     ...
     ((and (derived-mode-p 'prog-mode)
           (member major-mode '(clojure-mode clojurec-mode clojurescript-mode))) ; 如果要使用clojure就加入 clojure-mode clojurec-mode clojurescript-mode 即可
...
/// 有助于确认 LSP 后端切换是否生效。"
  ...
  (cond
   ...
   (t
    ...
    (when (fboundp 'lsp-eldoc-mode) (lsp-eldoc-mode 1))
    (lsp)
    (message "未检测到后端，已启动 lsp-mode，并启用 hover"))))
